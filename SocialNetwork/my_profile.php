...
// Control user in search mode
    ...
    if(isset($_SESSION["isSessionStarted"])) { require_once("crud_operations.php"); } ;
...
?>
        <h1> <?php echo $_POST["nombrecito"]; ?> </h1>
<?php
    } else {
?>
    <h1><?php echo "Estás en tu perfil, " . $_SESSION["whoami"];?> </h1> <!-- Si visitas tu usuario ves tu nombre y puedes añadir un post-->
